...
<%-- 
    Document   : GrimmsFairytales
    Created on : 12 5, 17, 6:14:18 PM
    Author     : Shierene
--%>
...
<html>
    <head>
        <title> Grimms' Fairy Tales (Puffin Classics) </title>
        <meta charset="UTF-8">
		...
		<section id="content">
			<div id="imagecontainer1">
				<div id="imagecontainer1" class="images">
                                            <img src="photos/W_5_Grimms' Fairy Tales.jpg">
...
<form action="GrimmsFairyTales" method="post">
