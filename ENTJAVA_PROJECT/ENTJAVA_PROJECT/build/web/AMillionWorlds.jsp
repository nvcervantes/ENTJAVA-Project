<%-- 
    Document   : AMillionWorlds
    Created on : 12 5, 17, 5:29:40 PM
    Author     : Shierene
--%>
...
<html>
    <head>
        <title> A Million Worlds with You </title>
        <meta charset="UTF-8">
		...
		<section id="content">
			<div id="imagecontainer1">
				<div id="imagecontainer1" class="images">
                                            <img src="photos/W_2 _ A Million Worlds with You.jpg">
                                ...
                                <form action="AMillionWorlds" method="post">
