...
<%-- 
    Document   : TheConsolationsofPhilosophy
    Created on : 12 5, 17, 8:39:35 PM
    Author     : Shierene
--%>
		...
		<section id="content">
			<div id="imagecontainer1">
				<div id="imagecontainer1" class="images">
                                            <img src="photos/W_6 _ The Consolations of Philosophy.jpg">
...
<form action="TheConsolationsofPhilosophy" method="post">
