...
<%-- 
    Document   : TheAlchemist
    Created on : 12 5, 17, 9:09:03 PM
    Author     : Shierene
--%>
...
<html>
    <head>
        <title> The Alchemist (25th Anniversary) </title>
        <meta charset="UTF-8">
		...
		<section id="content">
			<div id="imagecontainer1">
				<div id="imagecontainer1" class="images">
                                            <img src="photos/W_8 _ The Alchemist .jpg">
...
<form action="TheAlchemist" method="post">
