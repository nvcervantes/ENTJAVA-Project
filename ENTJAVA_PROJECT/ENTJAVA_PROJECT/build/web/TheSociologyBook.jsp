<%-- 
    Document   : TheSociologyBook
    Created on : 12 5, 17, 9:01:45 PM
    Author     : Shierene
--%>
...
<html>
    <head>
        <title> The Sociology Book </title>
        <meta charset="UTF-8">
		...
		<section id="content">
			<div id="imagecontainer1">
				<div id="imagecontainer1" class="images">
                                            <img src="photos/W_8 _ The Sociology Book.jpg">
...
<form action="TheSociologyBook" method="post">
