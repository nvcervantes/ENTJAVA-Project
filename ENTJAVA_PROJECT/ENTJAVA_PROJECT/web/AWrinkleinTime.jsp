<%@page session="true"%>
<%-- 
    Document   : AWrinkleinTime
    Created on : 12 5, 17, 5:31:56 PM
    Author     : Shierene
--%>
...
<html>
    <head>
        <title> A Wrinkle in Time: The Graphic Novel </title>
        <meta charset="UTF-8">
		...
		<section id="content">
			<div id="imagecontainer1">
				<div id="imagecontainer1" class="images">
                                            <img src="photos/W_3_A Wrinkle in Time.jpg">
                                ...
                                <form action="AWrinkleinTime" method="post">
