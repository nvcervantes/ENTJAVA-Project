...
<html>
    ...
    <div class="slideshow-container">
        <nav id="headnav">
				<a href="collections.jsp" style ="color: #6b2f23" >Education and Reference</a>
    ...
    <section class="NewArrival" id="horimenu2">
        ...
        <div id="left"> <div id="container" class="images">
                <a href="DeadlySkills.jsp"> <img id="logo" src="photos/100 Deadly Skills.jpg"/> </a>
		</div> </div>
             

  <div id="right"> <div id="container" class="images">
          <a href="Architecture101.jsp"> <img src="photos/Architecture 101.jpg">   </a>     
		</div></div>
  <div id="center"> <div id="container" class="images">
          <a href="Anatomy101.jsp"> <img src="photos/Anatomy 101.jpg">   </a>
		</div></div>
</div>
    ...
    <section class="NewArrival" id="horimenu2">
        ...
        <div id="container">
        <div id="left"> <div id="container" class="images">
                    <a href="BeingMortal.jsp">
                    <img src="photos/Being Mortal.jpg" >    
               </a>
		</div> </div>
           

  <div id="right"> <div id="container" class="images">
                    <a href="CPlusProgramming.jsp">
                    <img src="photos/Cplus Programming .jpg">  
                    </a>
		</div></div>
  <div id="center"> <div id="container" class="images">
                    <a href="CProgramming4.jsp">
                    <img src="photos/C Programming 4.jpg"> 
                    </a>
		</div></div>
     </div> </section>
    ...
    <section class="NewArrival" id="horimenu2">
        ...
        <div id="right"> <div id="container" class="images">
                     <a href="ExcelVBA.jsp">
                    <img src="photos/Excel VBA .jpg">  
                     </a>
        </div></div>
        <div id="center"> <div id="container" class="images">
                <a href="Excel2016.jsp">
                    <img src="photos/Excel 2016 in easy steps.jpg">  
                     </a>
		</div></div>
     </section>
     <section class="NewArrival" id="horimenu2">
