...
<html>
    ...
    <section class="NewArrival" id="horimenu2">
        ...
        <div id="left"> <div id="container" class="images">
                     <a href="AlicesAdventures.jsp"> <img src="photos/1_Alice's Adventures.jpg">   </a>     
		</div></div>
  <div id="right"> <div id="container" class="images">
                       <a href="AWrinkleinTime.jsp">
                     <img src="photos/3_A Wrinkle in Time.jpg">
                       </a>
		</div></div>
  <div id="center"> <div id="container" class="images">
                    <a href="AnimalFarm.jsp">
                    <img src="photos/2_Animal Farm.jpg">     
                    </a>
		</div></div>
</div>
    ...
    <section class="NewArrival" id="horimenu2">
        ...
        <div id="container">
       <div id="left"> <div id="container" class="images">
                    <a href="Countingby7s.jsp">
                    <img src="photos/4_Counting by 7s.jpg">    
                    </a>
		</div> </div>
             

  <div id="right"> <div id="container" class="images">
                    <a href="GulliversTravels.jsp">
                    <img src="photos/6_Gulliver's Travels.jpg">
                    </a>
		</div></div>
  <div id="center"> <div id="container" class="images">
                     <a href="GrimmsFairyTales.jsp">
                    <img src="photos/5_Grimms' Fairy Tales.jpg"> 
                     </a>
		</div></div>
     </div> </section>
    ...
    <section class="NewArrival" id="horimenu2">
        ...
        <div id="container">
        <div id="left"> <div id="container" class="images"> 
                 <a href="NorwegianWood.jsp">
                <img src="photos/7_Norwegian Wood.jpg">
                 </a>
        </div></div>
        <div id="right"> <div id="container" class="images">
                    <a href="Papa.jsp">
                     <img src="photos/9_Papa.jpg">
                    </a>
        </div></div>
        <div id="center"> <div id="container">
                    <a href="Oh.jsp" target='_blank'>
                     <img src="photos/8_Oh.jpg"> 
                    </a>
		</div></div>
     </section>
     <section class="NewArrival" id="horimenu2">
