...
<html>
    <head>
        <title> HTML5 in easy steps 2nd Edition </title>
        <meta charset="UTF-8">
        ...
        <header>
			...
			<nav id="headnav">
				...
				<a href="collections.jsp" style ="color: #3D4A39">Collections</a>
                                ...
                                <a href="login" style ="color: #3D4A39">Log out</a>
