...
<html>
    <head>
        <title> Weather 101: From Doppler Radar and Long-Range Forecasts to the Polar Vortex and Climate Change, Everything You Need to Know about the Study of Weather </title>
        <meta charset="UTF-8">
		...
		<section id="content">
			<div id="imagecontainer1">
				<div id="imagecontainer1" class="images">
                                            <img src="photos/W_10 _ Weather 101.jpg">
                                ...
                                <form action="Weather101" method="post">
