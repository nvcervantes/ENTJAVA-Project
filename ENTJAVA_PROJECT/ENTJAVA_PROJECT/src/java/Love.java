    ...
    protected void doPost (HttpServletRequest request, HttpServletResponse response)
        ...
        String stock = request.getParameter("stock");
         ...
         try {
            ...
            PreparedStatement pst = conn.prepareStatement("Select stock from book where stock>=1 and id=36");
            ...
            if (!rs.first()) {
                    ...
                    PreparedStatement pst1 = conn.prepareStatement("Update book set stock=stock-1 where id=36");
                    PreparedStatement pst2 = conn.prepareStatement("insert into user_books (user, book)"
                    + " values (?, ?)");

                    pst2.setString(1, "shierene");
                    pst2.setString(2, "Love");
                    pst1.executeUpdate();
                    pst2.executeUpdate();
