<%-- 
    Document   : TheAstronomyBook
    Created on : 12 5, 17, 8:30:08 PM
    Author     : Shierene
--%>
...
<html>
    <head>
        <title> The Astronomy Book </title>
        <meta charset="UTF-8">
		...
		<section id="content">
			<div id="imagecontainer1">
				<div id="imagecontainer1" class="images">
                                            <img src="photos/W_6 _The AstronomyBook.jpg">
...
<form action="TheAstronomyBook" method="post">
