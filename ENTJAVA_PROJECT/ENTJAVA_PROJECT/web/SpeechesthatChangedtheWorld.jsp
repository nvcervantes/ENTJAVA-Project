...
<%-- 
    Document   : SpeechesthatChangedtheWorld
    Created on : 12 5, 17, 8:25:42 PM
    Author     : Shierene
--%>
...
<html>
    <head>
        <title> Speeches That Changed the World </title>
        <meta charset="UTF-8">
		...
		<section id="content">
			<div id="imagecontainer1">
				<div id="imagecontainer1" class="images">
                                            <img src="photos/W_4 _ Speeches That Changed the World.jpg">
                                ...
                                <form action="SpeechesthatChangedtheWorld" method="post">
