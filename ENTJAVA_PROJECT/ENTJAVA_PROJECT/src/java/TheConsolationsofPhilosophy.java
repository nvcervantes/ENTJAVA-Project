...
@WebServlet(urlPatterns = {"/TheConsolationsofPhilosophy"})

public class TheConsolationsofPhilosophy extends HttpServlet {
    protected void doPost (HttpServletRequest request, HttpServletResponse response)
        ...
        String stock = request.getParameter("stock");
         ...
         try {
            ...
            PreparedStatement pst = conn.prepareStatement("Select stock from book where stock>=1 and id=33");
            ...
            if (!rs.first()) {
                    ...
                    pst2.setString(2, "The Consolations of Philosophy");
                    pst1.executeUpdate();
                    pst2.executeUpdate();
