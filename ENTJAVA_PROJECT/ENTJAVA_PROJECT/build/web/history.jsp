...
<html>
    ...
    <section class="NewArrival" id="horimenu2">
        ...
        <div id="left"> <div id="container" class="images">
                    <a href="AHistoryoftheWorld.jsp">
                    <img src="photos/1 _ A History of the World in 12 Maps.jpg" >    
                    </a>
		</div> </div>
  <div id="right"> <div id="container" class="images">
          <a href="Philosophy101.jsp">
                    <img src="photos/3 _ Philosophy 101.jpg">     
          </a>
		</div></div>
  <div id="center"> <div id="container" class="images">
           <a href="OnTyranny.jsp">
                    <img src="photos/2 _ On Tyranny.jpg">  
           </a>
		</div></div>
</div>
    ...
    <section class="NewArrival" id="horimenu2">
        ...
        <div id="container">
       <div id="left"> <div id="container" class="images">
               <a href="SpeechesthatChangedtheWorld.jsp">
                    <img src="photos/4 _ Speeches That Changed the World.jpg">    
               </a>
		</div> </div>
             
  <div id="right"> <div id="container" class="images">
           <a href="TheConsolationsofPhilosophy.jsp">
                    <img src="photos/6 _ The Consolations of Philosophy.jpg">       
           </a>
		</div></div>
  <div id="center"> <div id="container" class="images">
          <a href="StoryofPhilosophy.jsp">
                    <img src="photos/5 _ Story of Philosophy.jpg">
          </a>
		</div></div>
     </div> </section>
    ...
    <section class="NewArrival" id="horimenu2">
        ...
        <div id="container">
        <div id="left"> <div id="container" class="images"> 
                <a href="TheMiracleofDunkirk.jsp">
                <img src="photos/7 _ The Miracle of Dunkirk.jpg">
                </a>
        </div></div>
        <div id="right"> <div id="container" class="images">
                <a href="WorldHistory101.jsp">
                    <img src="photos/9 _ World History 101 Ancient.jpg">      
                </a>
        </div></div>
        <div id="center"> <div id="container" class="images">
                 <a href="TheOriginsofPolitical.jsp">
                    <img src="photos/8 _ The Origins of Political Order.jpg">     
                 </a> 
		</div></div>
     </section>
     <section class="NewArrival" id="horimenu2">
        ...
        <div id="container">
        <div id="left"> <div id="container" class="images"> 
                <a href="WorldHistoryinMinutes.jsp">
                <img src="photos/10 _ World History in Minutes.jpg">
                </a>
            </div></div> </section>
        <footer>
			<div id="backtotop">
