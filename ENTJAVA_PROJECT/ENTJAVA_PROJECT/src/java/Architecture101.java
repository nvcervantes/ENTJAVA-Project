...
@WebServlet(urlPatterns = {"/Architecture101"})

public class Architecture101 extends HttpServlet {
    protected void doPost (HttpServletRequest request, HttpServletResponse response)
        ...
        String stock = request.getParameter("stock");
         ...
         try {
            ...
            PreparedStatement pst = conn.prepareStatement("Select stock from book where stock>=1 and id=20");
            ...
            if (!rs.first()) {
                    ...
                    pst2.setString(2, "Architecture 101");
                    pst1.executeUpdate();
                    pst2.executeUpdate();
