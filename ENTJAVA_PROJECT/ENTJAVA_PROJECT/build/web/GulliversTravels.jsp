<%-- 
    Document   : GulliversTravels
    Created on : 12 5, 17, 8:44:45 PM
    Author     : Shierene
--%>
...
<html>
    <head>
        <title> Gulliver's Travels (Puffin Classics) </title>
        <meta charset="UTF-8">
		...
		<section id="content">
			<div id="imagecontainer1">
				<div id="imagecontainer1" class="images">
                                            <img src="photos/W_6_Gulliver's Travels.jpg">
...
<form action="GulliversTravels" method="post">
