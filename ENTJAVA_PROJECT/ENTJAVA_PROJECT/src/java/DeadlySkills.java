...
@WebServlet(urlPatterns = {"/DeadlySkills"})

public class DeadlySkills extends HttpServlet {
    protected void doPost (HttpServletRequest request, HttpServletResponse response)
        ...
        String stock = request.getParameter("stock");
         ...
         try {
            ...
            PreparedStatement pst = conn.prepareStatement("Select stock from book where stock>=1 and id=8");
