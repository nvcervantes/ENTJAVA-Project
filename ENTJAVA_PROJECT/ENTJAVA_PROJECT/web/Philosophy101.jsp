...
<%-- 
    Document   : Philosophy101
    Created on : 12 5, 17, 6:28:03 PM
    Author     : Shierene
--%>
...
<html>
    <head>
        <title> Philosophy 101: From Plato and Socrates to Ethics and Metaphysics, an Essential Primer on the History of Thought </title>
        <meta charset="UTF-8">
		...
		<section id="content">
			<div id="imagecontainer1">
				<div id="imagecontainer1" class="images">
                                            <img src="photos/W_3 _ Philosophy 101.jpg">
                                ...
                                <form action="Philosophy101" method="post">
