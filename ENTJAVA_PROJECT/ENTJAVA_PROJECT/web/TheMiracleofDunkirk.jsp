<%-- 
    Document   : TheMiracleofDunkirk
    Created on : 12 5, 17, 8:49:04 PM
    Author     : Shierene
--%>
...
<html>
    <head>
        <title> The Miracle of Dunkirk: The True Story of Operation Dynamo </title>
        <meta charset="UTF-8">
		...
		<section id="content">
			<div id="imagecontainer1">
				<div id="imagecontainer1" class="images">
                                            <img src="photos/W_7 _ The Miracle of Dunkirk.jpg">
...
<form action="TheMiracleofDunkirk" method="post">
