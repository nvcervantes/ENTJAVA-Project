<%-- 
    Document   : IllustratedBrief
    Created on : 12 5, 17, 6:19:06 PM
    Author     : Shierene
--%>
...
<html>
    <head>
        <title> Illustrated Brief History of Time and The Universe in a Nutshell</title>
        <meta charset="UTF-8">
		...
		<section id="content">
			<div id="imagecontainer1">
				<div id="imagecontainer1" class="images">
                                            <img src="photos/W_4 _ Illustrated Brief History of Time and The Universe in a Nutshell.jpg">
                                ...
                                <form action="IllustratedBrief" method="post">
