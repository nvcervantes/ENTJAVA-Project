<%-- 
    Document   : WorldHistoryinMinutes
    Created on : 12 5, 17, 8:33:21 PM
    Author     : Shierene
--%>
...
<html>
    <head>
        <title> World History in Minutes </title>
        <meta charset="UTF-8">
		...
		<section id="content">
			<div id="imagecontainer1">
				<div id="imagecontainer1" class="images">
                                            <img src="photos/W_10 _ World History in Minutes.jpg">
                               ...
                               <form action="WorldHistoryinMinutes" method="post">
