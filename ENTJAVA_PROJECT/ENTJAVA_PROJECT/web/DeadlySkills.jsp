<%-- 
    Document   : DeadlySkills
    Created on : 12 5, 17, 6:05:08 PM
    Author     : Shierene
--%>
...
<html>
    <head>
        <title> 100 Deadly Skills: The SEAL Operative's Guide to Eluding Pursuers, Evading Capture, and Surviving Any Dangerous Situation </title>
        <meta charset="UTF-8">
		...
		<section id="content">
			<div id="imagecontainer1">
				<div id="imagecontainer1" class="images">
                                            <img src="photos/W_100 Deadly Skills.jpg">
                                    
                                    
				</div>
			</div> <aside id="infospace1">
                                <div id="imagecontainer2" class="images">
                                <form action="DeadlySkills" method="post">
