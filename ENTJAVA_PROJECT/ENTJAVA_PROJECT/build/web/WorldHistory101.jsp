<%-- 
    Document   : WorldHistory101
    Created on : 12 5, 17, 9:27:09 PM
    Author     : Shierene
--%>
...
<html>
    <head>
        <title> World History 101: From ancient Mesopotamia and the Viking conquests to NATO and WikiLeaks, an essential primer on world history </title>
        <meta charset="UTF-8">
		...
		<section id="content">
			<div id="imagecontainer1">
				<div id="imagecontainer1" class="images">
                                            <img src="photos/W_9 _ World History 101 Ancient.jpg">
...
<form action="WorldHistory101Ancient" method="post">
