<%-- 
    Document   : TheOnlyWoman
    Created on : 12 5, 17, 8:51:06 PM
    Author     : Shierene
--%>
...
<html>
    <head>
        <title> The Only Woman in the Room: Why Science Is Still a Boys' Club </title>
        <meta charset="UTF-8">
		...
		<section id="content">
			<div id="imagecontainer1">
				<div id="imagecontainer1" class="images">
                                            <img src="photos/W_7 _ The Only Woman in the Room Why Science Is Still a Boys' Club.jpg">
...
<form action="TheOnlyWoman" method="post">
