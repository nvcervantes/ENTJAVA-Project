...
<%-- 
    Document   : HowFoodWorks
    Created on : 12 5, 17, 6:15:29 PM
    Author     : Shierene
--%>
		...
		<section id="content">
			<div id="imagecontainer1">
				<div id="imagecontainer1" class="images">
                                            <img src="photos/W_2 _ How Food Works.jpg">
                                ...
                                <form action="HowFoodWorks" method="post">
