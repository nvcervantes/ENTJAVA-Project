...
<%-- 
    Document   : HowtheBodyWorks
    Created on : 12 5, 17, 6:16:56 PM
    Author     : Shierene
--%>
...
<html>
    <head>
        <title> How the Body Works </title>
        <meta charset="UTF-8">
		...
		<section id="content">
			<div id="imagecontainer1">
				<div id="imagecontainer1" class="images">
                                            <img src="photos/W_3 _ How the Body Works.jpg">
                                ...
                                <form action="HowtheBodyWorks" method="post">
