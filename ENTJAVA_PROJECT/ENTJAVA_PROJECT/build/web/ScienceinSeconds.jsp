...
<%-- 
    Document   : ScienceinSeconds
    Created on : 12 5, 17, 6:29:34 PM
    Author     : Shierene
--%>
...
<html>
    <head>
        <title> Science in Seconds </title>
        <meta charset="UTF-8">
		...
		<section id="content">
			<div id="imagecontainer1">
				<div id="imagecontainer1" class="images">
                                            <img src="photos/W_5 _ Science in Seconds.jpg">
                                ...
                                <form action="ScienceinSeconds" method="post">
