...
<%-- 
    Document   : StoryofPhilosophy
    Created on : 12 5, 17, 8:29:00 PM
    Author     : Shierene
--%>
...
<html>
    <head>
        <title> Story of Philosophy: A History of Western Thought </title>
        <meta charset="UTF-8">
		...
		<section id="content">
			<div id="imagecontainer1">
				<div id="imagecontainer1" class="images">
                                            <img src="photos/W_5 _ Story of Philosophy.jpg">
                                ...
                                <form action="StoryofPhilosophy" method="post">
