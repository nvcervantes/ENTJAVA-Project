...
<%-- 
    Document   : TheOriginsofPolitical
    Created on : 12 5, 17, 8:58:51 PM
    Author     : Shierene
--%>
		...
		<section id="content">
			<div id="imagecontainer1">
				<div id="imagecontainer1" class="images">
                                            <img src="photos/W_8 _ The Origins of Political Order.jpg">
...
<form action="TheOriginsofPoliticalOrder" method="post">
