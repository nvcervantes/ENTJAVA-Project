...
<%-- 
    Document   : Architecture101
    Created on : 12 5, 17, 5:59:11 PM
    Author     : Shierene
--%>
...
<html>
    <head>
        <title> Architecture 101: From Frank Gehry to Ziggurats, an Essential Guide to Building Styles and Materials </title>
        <meta charset="UTF-8">
		...
		<section id="content">
			<div id="imagecontainer1">
				<div id="imagecontainer1" class="images">
                                            <img src="photos/W_Architecture 101.jpg">
                                ...
                                <form action="Architecture101" method="post">
