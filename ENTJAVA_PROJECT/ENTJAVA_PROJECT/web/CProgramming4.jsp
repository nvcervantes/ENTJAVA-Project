...
<%-- 
    Document   : CProgramming4
    Created on : 12 5, 17, 6:02:19 PM
    Author     : Shierene
--%>
...
<html>
    <head>
        <title> C Programming in easy steps 4th Edition </title>
        <meta charset="UTF-8">
		...
		<section id="content">
			<div id="imagecontainer1">
				<div id="imagecontainer1" class="images">
                                            <img src="photos/W_C Programming 4.jpg">
                                    
                                    
				</div>
			</div> <aside id="infospace1">
                                <div id="imagecontainer2" class="images">
                                <form action="CProgramming4" method="post">
