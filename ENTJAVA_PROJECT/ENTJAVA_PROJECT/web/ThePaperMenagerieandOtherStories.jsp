...
<%-- 
    Document   : ThePaperMenagerieandOtherStories
    Created on : 12 5, 17, 8:31:10 PM
    Author     : Shierene
--%>
...
<html>
    <head>
        <title> The Paper Menagerie and Other Stories </title>
        <meta charset="UTF-8">
		...
		<section id="content">
			<div id="imagecontainer1">
				<div id="imagecontainer1" class="images">
                                            <img src="photos/W_10 _ The Paper Menagerie and Other Stories.jpg">
                                ...
                                <form action="ThePaperMenagerieandOtherStories" method="post">
