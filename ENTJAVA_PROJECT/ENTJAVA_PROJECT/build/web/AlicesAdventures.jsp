<%@page session="true"%>
<%-- 
    Document   : AlicesAdventures
    Created on : 12 5, 17, 5:39:03 PM
    Author     : Shierene
--%>
...
<html>
    <head>
        <title> Alice's Adventures in Wonderland and Through the Looking-Glass (Barnes & Noble Flexibound Editions) </title>
        <meta charset="UTF-8">
		...
		<section id="content">
			<div id="imagecontainer1">
				<div id="imagecontainer1" class="images">
                                            <img src="photos/W_1_Alice's Adventures.jpg">
                                ...
                                <form action="AlicesAdventures" method="post">
